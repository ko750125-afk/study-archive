  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-4 right-4 w-10 h-10 bg-white/90 backdrop-blur-md text-red-500 rounded-2xl shadow-lg border border-red-50 flex items-center justify-center transition-all z-20 hover:bg-red-50 hover:scale-110 active:scale-90 opacity-100 md:opacity-0 md:group-hover:opacity-100"
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`flex items-center justify-center w-10 h-10 rounded-xl transition-all border ${
              ...
              : "bg-surface-container/30 text-on-surface-variant/30 border-outline-variant/5 hover:bg-amber-50 hover:text-amber-500 hover:border-amber-200"
            }`}
          >
      ...
      {/* Action Hover Indicator (hidden on mobile) */}
      <div className="absolute right-6 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-primary text-white hidden md:flex items-center justify-center opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 shadow-2xl shadow-primary/30">
